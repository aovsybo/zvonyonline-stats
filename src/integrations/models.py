...
class CallDataInfo(models.Model):
    ...
    lead_id = models.CharField(max_length=255, null=True)
    ...
    lead_emails = models.JSONField(default=list, null=True)
    ...
    lead_tags = models.JSONField(default=list, null=True)
    lead_phones = models.CharField(max_length=255, null=True)
    ...
    contact_emails = models.JSONField(default=list, null=True)
    ...
    contact_tags = models.JSONField(default=list, null=True)
    ...
    call_phone = models.CharField(max_length=255, null=True)
    call_source = models.CharField(max_length=255, null=True)
    call_direction = models.CharField(max_length=255, null=True)
    call_params = models.JSONField(default=dict, null=True)
    call_lead_id = models.CharField(max_length=255, null=True)
    call_organization_id = models.CharField(max_length=255, null=True)
    call_user_id = models.CharField(max_length=255, null=True)
    ...
    call_reason = models.CharField(max_length=255, null=True)
    call_duration = models.IntegerField(null=True)
    call_scenario_id = models.CharField(max_length=255, null=True)
    call_result_id = models.CharField(max_length=255, null=True)
    ...
    call_call_type = models.CharField(max_length=255, null=True)
    call_region = models.CharField(max_length=255, null=True)
    call_local_time = models.CharField(max_length=255, null=True)
    call_call_project_id = models.CharField(max_length=255, null=True)
    call_call_project_title = models.CharField(max_length=255, null=True)
    call_scenario_result_group_id = models.CharField(max_length=255, null=True)
    call_scenario_result_group_title = models.CharField(max_length=255, null=True)

    call_result_result_id = models.CharField(max_length=255, null=True)
    call_result_result_name = models.CharField(max_length=255, null=True)
